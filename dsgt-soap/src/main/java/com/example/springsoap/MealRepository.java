...
public class MealRepository {
    ...
    public void initData() {
        ...
        order1.setMealName("Steak");
        order1.setAddress("pope's college");
    ...
    public boolean addOrder(Order order) {
        if (order == null || order.getMealName() == null || order.getMealName().isEmpty())
            return false;

        Meal meal = meals.get(order.getMealName());
        if (meal == null)
            return false;
